...
You can also set views to an array:

  set :views, [File.dirname(__FILE__) + '/templates', '/some/other/dir']

If the template could not be found and :views is a String rendering
will fail with Errno::ENOENT. If :views is an Array, the error will
be Sinatra::Templates::TemplateNotFound. The inconsistency is
